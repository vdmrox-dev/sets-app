...
## Client Profile
- Goal: ${goal}
- Training session groups: ${sessionGroups}
...
## Rules
- Create exactly ${sessionGroups} session group(s) in the "days" array. Each group is one distinct session targeting its own set of muscle groups (e.g. chest + biceps, back + triceps, legs).
